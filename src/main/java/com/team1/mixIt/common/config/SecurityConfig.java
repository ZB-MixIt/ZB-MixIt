    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(customizer -> customizer
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/home/views/weekly").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/home/recommendations/today").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/home/popular/combos").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/home/category/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/home/bookmarks").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/tags/autocomplete").permitAll()
                        .requestMatchers(HttpMethod.GET,    "/api/v1/notifications/**").authenticated()
                        .requestMatchers(HttpMethod.POST,  "/api/v1/users/my-page").authenticated()
                        .requestMatchers(HttpMethod.PUT,   "/api/v1/users/my-page").authenticated()
                        .requestMatchers(HttpMethod.GET,   "/api/v1/users/my-page/**").authenticated()
